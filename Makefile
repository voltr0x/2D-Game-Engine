...
run-p: bin/platformer/main-platformer
	$<
run-b: bin/breakout/main-breakout
	$<
run-breakout: bin/breakout/main-breakout
	$<
run-e: bin/editor/main-editor
	$<
run-editor: bin/editor/main-editor
	$<
run-c: bin/custom/main-custom
	$<
run-custom: bin/custom/main-custom
	$<
...
EXTERN_SOURCES=extern/box2d-2.4.1/src
ifeq ($(OS),Windows_NT)
